...
def create_lmdb_for_reds():
    ...
    """
    # train_sharp
    folder_path = "/home/vherfeld/storage/vherfeld/datasets/REDS/train_sharp"
    lmdb_path = "/home/vherfeld/storage/vherfeld/datasets/REDS/train_sharp_with_val.lmdb"
    ...
    # train_sharp_bicubic
    folder_path = "/home/vherfeld/storage/vherfeld/datasets/REDS/train_sharp_bicubic/X4"
    lmdb_path = "/home/vherfeld/storage/vherfeld/datasets/REDS/train_sharp_bicubic_with_val.lmdb"
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)

    # # train_blur (for video deblurring)
    # folder_path = "/home/vherfeld/storage/vherfeld/datasets/REDS_blur/train_blur"
    # lmdb_path = "/home/vherfeld/storage/vherfeld/datasets/REDS_blur/train_blur_with_val.lmdb"
    # img_path_list, keys = prepare_keys_reds(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)

    # train_blur_bicubic (for video deblurring-sr)
    # folder_path = "/home/vherfeld/storage/vherfeld/datasets/REDS_blur_bicubic/train_blur_bicubic"
    # lmdb_path = "/home/vherfeld/storage/vherfeld/datasets/REDS_blur_bicubic/train_blur_bicubic_with_val.lmdb"
    # img_path_list, keys = prepare_keys_reds(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)
