...
def define_G(opt):
    ...
    # ----------------------------------------
        ...
        netG = STVSRNet(
            ...
            fusion_softmax=opt_net.get("fusion_softmax", False),
            ...
            shared_stem=opt_net.get("shared_stem", "resunet"),
            shared_stem_nc=opt_net.get("shared_stem_nc", [16, 16, 16, 16]),
            ...
            bspline_flow_scale=opt_net.get("bspline_flow_scale", 20.0),
            bspline_confidence_splat=opt_net.get("bspline_confidence_splat", False),
            bspline_flow_anchor=opt_net.get("bspline_flow_anchor", True),
            bspline_stem=opt_net.get("bspline_stem", "resunet"),
            bspline_stem_nc=opt_net.get("bspline_stem_nc", [16, 16, 16, 16]),
            bspline_stem_nb=opt_net.get("bspline_stem_nb", 1),
            bspline_stem_out=opt_net.get("bspline_stem_out", 64),
            vis_traj_shared_coefficients=opt_net.get("vis_traj_shared_coefficients", True),
            traj_direct_coefficients=opt_net.get("traj_direct_coefficients", False),
            vis_basis=opt_net.get("vis_basis", "bspline"),
            flow_scale_enabled=opt_net.get("flow_scale_enabled", True),
            vis_direct_coefficients=opt_net.get("vis_direct_coefficients", False),
            decoupled_z_head=opt_net.get("decoupled_z_head", True),
            vis_head_n_freqs=opt_net.get("vis_head_n_freqs", 2),
